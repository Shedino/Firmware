/** @file
 *	@brief MAVLink comm protocol testsuite generated from unibo_mavlink.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef UNIBO_MAVLINK_TESTSUITE_H
#define UNIBO_MAVLINK_TESTSUITE_H
...
static void mavlink_test_unibo_mavlink(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_unibo_mavlink(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_unibo_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_unibo_parameters_t packet_in = {
		17.0,
	}45.0,
	}73.0,
	}101.0,
	...
	mavlink_unibo_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.Offset_T = packet_in.Offset_T;
        	packet1.lat_mode = packet_in.lat_mode;
        	packet1.delta = packet_in.delta;
        	packet1.K1 = packet_in.K1;
        	packet1.L1 = packet_in.L1;
        	packet1.Ixy = packet_in.Ixy;
        	packet1.K2 = packet_in.K2;
        	packet1.L2 = packet_in.L2;
        	packet1.Iz = packet_in.Iz;
        	packet1.KpAttX = packet_in.KpAttX;
        	packet1.KpAttY = packet_in.KpAttY;
        	packet1.KpAttZ = packet_in.KpAttZ;
        	packet1.KdAttX = packet_in.KdAttX;
        	packet1.KdAttY = packet_in.KdAttY;
        	packet1.KdAttZ = packet_in.KdAttZ;
        	packet1.KiAttX = packet_in.KiAttX;
        	packet1.KiAttY = packet_in.KiAttY;
        	packet1.KiAttZ = packet_in.KiAttZ;
        	packet1.GE = packet_in.GE;
        	packet1.epsilon = packet_in.epsilon;
        	packet1.XY_Multiplier = packet_in.XY_Multiplier;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_unibo_parameters_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_unibo_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_unibo_parameters_pack(system_id, component_id, &msg , packet1.Offset_T , packet1.lat_mode , packet1.delta , packet1.K1 , packet1.L1 , packet1.Ixy , packet1.K2 , packet1.L2 , packet1.Iz , packet1.KpAttX , packet1.KpAttY , packet1.KpAttZ , packet1.KdAttX , packet1.KdAttY , packet1.KdAttZ , packet1.KiAttX , packet1.KiAttY , packet1.KiAttZ , packet1.GE , packet1.epsilon , packet1.XY_Multiplier , packet1.offset_x , packet1.offset_y , packet1.offset_z );
	mavlink_msg_unibo_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_unibo_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Offset_T , packet1.lat_mode , packet1.delta , packet1.K1 , packet1.L1 , packet1.Ixy , packet1.K2 , packet1.L2 , packet1.Iz , packet1.KpAttX , packet1.KpAttY , packet1.KpAttZ , packet1.KdAttX , packet1.KdAttY , packet1.KdAttZ , packet1.KiAttX , packet1.KiAttY , packet1.KiAttZ , packet1.GE , packet1.epsilon , packet1.XY_Multiplier , packet1.offset_x , packet1.offset_y , packet1.offset_z );
	mavlink_msg_unibo_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_unibo_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_unibo_parameters_send(MAVLINK_COMM_1 , packet1.Offset_T , packet1.lat_mode , packet1.delta , packet1.K1 , packet1.L1 , packet1.Ixy , packet1.K2 , packet1.L2 , packet1.Iz , packet1.KpAttX , packet1.KpAttY , packet1.KpAttZ , packet1.KdAttX , packet1.KdAttY , packet1.KdAttZ , packet1.KiAttX , packet1.KiAttY , packet1.KiAttZ , packet1.GE , packet1.epsilon , packet1.XY_Multiplier , packet1.offset_x , packet1.offset_y , packet1.offset_z );
	mavlink_msg_unibo_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_unibo_hl_trajectory(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_unibo_hl_trajectory_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.dot_p_refX = packet_in.dot_p_refX;
        	packet1.dot_p_refY = packet_in.dot_p_refY;
        	packet1.dot_p_refZ = packet_in.dot_p_refZ;
...
static void mavlink_test_unibo_mavlink(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // UNIBO_MAVLINK_TESTSUITE_H
