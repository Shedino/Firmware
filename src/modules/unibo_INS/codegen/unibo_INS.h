 ...
 */
#ifndef RTW_HEADER_unibo_INS_h_
#define RTW_HEADER_unibo_INS_h_
#ifndef unibo_INS_COMMON_INCLUDES_
# define unibo_INS_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* unibo_INS_COMMON_INCLUDES_ */

#include "unibo_INS_types.h"
...
#define unibo_INS_rtModel              RT_MODEL_unibo_INS_T
...
typedef struct {
  ...
  real_T l;                            /* '<S2>/MATLAB Function' */
  real_T m;                            /* '<S2>/MATLAB Function' */
  real_T n;                            /* '<S2>/MATLAB Function' */
  real_T p_pos[3];                     /* '<S2>/Filtro Lineare' */
  real_T v_pos[3];                     /* '<S2>/Filtro Lineare' */
  real_T xa_pos[3];                    /* '<S2>/Filtro Lineare' */
  real_T p2_gps[3];                    /* '<S2>/Filtro Lineare' */
...
typedef struct {
  real_T earth_par[6];                 /* '<Root>/earth_par' */
  real_T simulation_par[4];            /* '<Root>/simulation_par' */
  real_T filter_gain[23];              /* '<Root>/filter_gain' */
  real_T pos_meas[3];                  /* '<Root>/pos_meas' */
  real_T vel_meas[3];                  /* '<Root>/vel_meas' */
  real_T acc_meas[3];                  /* '<Root>/acc_meas' */
  real_T Rnb[9];                       /* '<Root>/Rnb' */
} ExtU_unibo_INS_T;

/* External outputs (root outports fed by signals with auto storage) */
typedef struct {
  real_T local_xyz[3];                 /* '<Root>/local_xyz' */
...
#define rtB                            unibo_INS_B
#define BlockIO                        B_unibo_INS_T
#define rtU                            unibo_INS_U
#define ExternalInputs                 ExtU_unibo_INS_T
#define rtY                            unibo_INS_Y
#define ExternalOutputs                ExtY_unibo_INS_T
#define rtDWork                        unibo_INS_DW
#define D_Work                         DW_unibo_INS_T

/* Real-time Model Data Structure */
struct tag_RTM_unibo_INS_T {
  const char_T *path;
...
/* Block signals (auto storage) */
extern B_unibo_INS_T unibo_INS_B;

/* Block states (auto storage) */
extern DW_unibo_INS_T unibo_INS_DW;

/* External inputs (root inport signals with auto storage) */
extern ExtU_unibo_INS_T unibo_INS_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_unibo_INS_T unibo_INS_Y;

/* Real-time Model object */
extern RT_MODEL_unibo_INS_T *const unibo_INS_M;
